...
class UpdatePartyImageUrl {
  final PartyRepository _partyRepository;

  const UpdatePartyImageUrl(this._partyRepository);

  Future<Either<Failure, NoParams>> call(String partyId, String downloadUrl) {
    return _partyRepository.updatePartyImageUrl(partyId, downloadUrl);
  }
}
